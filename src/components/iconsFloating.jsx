...
export function IconsFloating() {
  return (
    <div className="icons-skills">
      ...
      <span className="animate-pulse absolute top-[70%] right-[30%] border border-blue-100/20 bg-blue-200/10 p-2 w-15 h-15 rounded-full hover:border-gray-300/50 items-center justify-center hidden sm:flex hover:transform hover:translate-x-2 hover:translate-y-2 transition-all duration-300 ease-in-out">
        <RiTailwindCssFill className="w-6 h-6 text-sky-300" />
      </span>
    </div>
  );
}
